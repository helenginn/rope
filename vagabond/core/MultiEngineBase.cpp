...
MultiEngineBase::MultiEngineBase()
{
...
void MultiEngineBase::clearTasks()
{
	_immediate->clear();
	_hanging->clear();
...
void MultiEngineBase::addImmediateTask(BaseTask *bt)
{
	_immediate->addTask(bt);
}

void MultiEngineBase::addHangingTask(BaseTask *bt)
{
	_hanging->addTask(bt);
}
