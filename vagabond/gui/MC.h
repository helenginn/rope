// MIT license from https://raw.githubusercontent.com/aparis69/MarchingCubeCpp
...
namespace MC
{
	...
	void marching_cube(const MC_FLOAT* field, muint nx, muint ny, muint nz, MC_FLOAT thresh, mcMesh& outputMesh);
