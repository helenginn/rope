set path=vagabond/core/**,vagabond/gui/**,vagabond/gui/elements/**,vagabond/utils/**,vagabond/cmd/**,vagabond/c4x/**,vagabond/untangle/**,vagabond/core/protonic/**,vagabond/mabscape/**
